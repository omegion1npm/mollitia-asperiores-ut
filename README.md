...
```sh
npm i @omegion1npm/mollitia-asperiores-ut
```
...
```typescript
import { REGEX, SimpleRegexBuilder } from '@omegion1npm/mollitia-asperiores-ut';
```

#### CommonJS modules

```javascript
const { REGEX, SimpleRegexBuilder} = require('@omegion1npm/mollitia-asperiores-ut');
```
